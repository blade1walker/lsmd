      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              href="/admin/login"
              className="px-4 py-2 text-sm font-medium text-black bg-[#eab308] hover:bg-[#ca8a04] rounded-lg transition-colors"
            >
              Admin Login
            </a>
          </div>
          ...
          {mobileOpen && (
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <a href="/admin/login" className="px-4 py-2 text-sm font-medium text-black bg-[#eab308] hover:bg-[#ca8a04] rounded-lg text-center mt-2">
                  Admin Login
                </a>
              </div>
            </motion.div>
