...
const navItems: {
  ...
  { href: "/admin/interviews", label: "Promotions & Interviews", icon: ClipboardCheck, permission: INTERVIEW_SECTION_PERMISSIONS },
  ...
  { href: "/admin/calls", label: "Call Log", icon: Ambulance, permission: CALL_SECTION_PERMISSIONS },
